...
export const docSections: DocSection[] = [
  {
    ...
    order: 1,
    children: [
      { id: 'welcome', title: 'Welcome & Overview', slug: 'welcome', category: 'basics', order: 1 },
      { id: 'architecture', title: 'Site Architecture Overview', slug: 'architecture', category: 'basics', order: 2 },
      { id: 'quick-reference', title: 'Quick Reference Guide', slug: 'quick-reference', category: 'basics', order: 3 },
      { id: 'emergency-contacts', title: 'Emergency Contacts & Support', slug: 'emergency-contacts', category: 'basics', order: 4 },
    ],
  },
  {
    id: 'user-management',
    ...
    order: 2,
    children: [
      { id: 'roles-permissions', title: 'User Roles & Permissions', slug: 'roles-permissions', category: 'administration', order: 1 },
      { id: 'add-edit-users', title: 'Adding/Editing Users', slug: 'add-edit-users', category: 'administration', order: 2 },
      { id: 'password-management', title: 'Password Management', slug: 'password-management', category: 'administration', order: 3 },
      { id: 'role-based-access', title: 'Role-Based Access Control', slug: 'role-based-access', category: 'administration', order: 4 },
      { id: 'registration-settings', title: 'User Registration Settings', slug: 'registration-settings', category: 'administration', order: 5 },
    ],
  },
  {
    ...
    order: 3,
    children: [
      { id: 'dashboard-overview', title: 'WordPress Dashboard Overview', slug: 'dashboard-overview', category: 'content', order: 1 },
      { id: 'create-edit-pages', title: 'Creating/Editing Pages', slug: 'create-edit-pages', category: 'content', order: 2 },
      { id: 'blog-management', title: 'Blog Post Management', slug: 'blog-management', category: 'content', order: 3 },
      { id: 'media-library', title: 'Media Library Management', slug: 'media-library', category: 'content', order: 4 },
      { id: 'menu-management', title: 'Menu Management', slug: 'menu-management', category: 'content', order: 5 },
      { id: 'widget-management', title: 'Widget Management', slug: 'widget-management', category: 'content', order: 6 },
    ],
  },
  {
    id: 'event-management',
    ...
    order: 4,
    children: [
      { id: 'event-creation', title: 'Event Creation Process', slug: 'event-creation', category: 'events', order: 1 },
      { id: 'event-categories', title: 'Event Categories & Tags', slug: 'event-categories', category: 'events', order: 2 },
      { id: 'registration-management', title: 'Registration Management', slug: 'registration-management', category: 'events', order: 3 },
      { id: 'calendar-config', title: 'Event Calendar Configuration', slug: 'calendar-config', category: 'events', order: 4 },
      { id: 'email-notifications', title: 'Email Notifications Setup', slug: 'email-notifications', category: 'events', order: 5 },
      { id: 'recurring-events', title: 'Recurring Events Setup', slug: 'recurring-events', category: 'events', order: 6 },
    ],
  },
  {
    id: 'service-booking',
    ...
    order: 5,
    children: [
      { id: 'booking-overview', title: 'Booking System Overview', slug: 'booking-overview', category: 'services', order: 1 },
      { id: 'service-categories', title: 'Service Categories Setup', slug: 'service-categories', category: 'services', order: 2 },
      { id: 'volunteer-slots', title: 'Volunteer Slot Management', slug: 'volunteer-slots', category: 'services', order: 3 },
      { id: 'booking-confirmations', title: 'Booking Confirmations', slug: 'booking-confirmations', category: 'services', order: 4 },
      { id: 'cancellation-policies', title: 'Cancellation Policies', slug: 'cancellation-policies', category: 'services', order: 5 },
      { id: 'reporting-analytics', title: 'Reporting & Analytics', slug: 'reporting-analytics', category: 'services', order: 6 },
    ],
  },
  {
    ...
    order: 6,
    children: [
      { id: 'active-theme', title: 'Active Theme Configuration', slug: 'active-theme', category: 'design', order: 1 },
      { id: 'customizer-settings', title: 'Customizer Settings', slug: 'customizer-settings', category: 'design', order: 2 },
      { id: 'header-footer', title: 'Header/Footer Management', slug: 'header-footer', category: 'design', order: 3 },
      { id: 'color-schemes', title: 'Color Scheme Management', slug: 'color-schemes', category: 'design', order: 4 },
      { id: 'logo-branding', title: 'Logo & Branding Updates', slug: 'logo-branding', category: 'design', order: 5 },
      { id: 'responsive-design', title: 'Responsive Design Settings', slug: 'responsive-design', category: 'design', order: 6 },
    ],
  },
  {
    ...
    order: 7,
    children: [
      { id: 'installed-plugins', title: 'Installed Plugins Overview', slug: 'installed-plugins', category: 'plugins', order: 1 },
      { id: 'plugin-updates', title: 'Plugin Updates & Maintenance', slug: 'plugin-updates', category: 'plugins', order: 2 },
      { id: 'plugin-settings', title: 'Plugin-Specific Settings', slug: 'plugin-settings', category: 'plugins', order: 3 },
      { id: 'plugin-conflicts', title: 'Troubleshooting Plugin Conflicts', slug: 'plugin-conflicts', category: 'plugins', order: 4 },
      { id: 'backup-restore', title: 'Backup & Restore Procedures', slug: 'backup-restore', category: 'plugins', order: 5 },
    ],
  },
  {
    ...
    order: 8,
    children: [
      { id: 'functions-php', title: 'functions.php Customizations', slug: 'functions-php', category: 'development', order: 1 },
      { id: 'custom-code', title: 'Custom Code Snippets', slug: 'custom-code', category: 'development', order: 2 },
      { id: 'database-modifications', title: 'Database Modifications', slug: 'database-modifications', category: 'development', order: 3 },
      { id: 'child-theme', title: 'Child Theme Implementation', slug: 'child-theme', category: 'development', order: 4 },
      { id: 'custom-post-types', title: 'Custom Post Types', slug: 'custom-post-types', category: 'development', order: 5 },
      { id: 'custom-fields', title: 'Custom Fields Setup', slug: 'custom-fields', category: 'development', order: 6 },
    ],
  },
  {
    ...
    order: 9,
    children: [
      { id: 'wordpress-updates', title: 'WordPress Updates', slug: 'wordpress-updates', category: 'security', order: 1 },
      { id: 'backup-procedures', title: 'Backup Procedures', slug: 'backup-procedures', category: 'security', order: 2 },
      { id: 'security-best-practices', title: 'Security Best Practices', slug: 'security-best-practices', category: 'security', order: 3 },
      { id: 'performance-optimization', title: 'Performance Optimization', slug: 'performance-optimization', category: 'security', order: 4 },
      { id: 'ssl-certificates', title: 'SSL Certificate Management', slug: 'ssl-certificates', category: 'security', order: 5 },
      { id: 'malware-scanning', title: 'Malware Scanning', slug: 'malware-scanning', category: 'security', order: 6 },
    ],
  },
  {
    id: 'troubleshooting',
    ...
    order: 10,
    children: [
      { id: 'common-issues', title: 'Common Issues & Solutions', slug: 'common-issues', category: 'support', order: 1 },
      { id: 'error-logs', title: 'Error Log Analysis', slug: 'error-logs', category: 'support', order: 2 },
      { id: 'debug-mode', title: 'Debug Mode Activation', slug: 'debug-mode', category: 'support', order: 3 },
      { id: 'plugin-conflicts', title: 'Plugin Conflict Resolution', slug: 'plugin-conflicts', category: 'support', order: 4 },
      { id: 'database-repair', title: 'Database Repair', slug: 'database-repair', category: 'support', order: 5 },
      { id: 'emergency-recovery', title: 'Emergency Recovery', slug: 'emergency-recovery', category: 'support', order: 6 },
    ],
  },
  {
    id: 'video-tutorials',
    ...
    order: 11,
    children: [
      { id: 'getting-started-videos', title: 'Getting Started Videos', slug: 'getting-started-videos', category: 'tutorials', order: 1 },
      { id: 'advanced-features', title: 'Advanced Feature Walkthroughs', slug: 'advanced-features', category: 'tutorials', order: 2 },
      { id: 'maintenance-procedures', title: 'Maintenance Procedures', slug: 'maintenance-procedures', category: 'tutorials', order: 3 },
      { id: 'troubleshooting-guides', title: 'Troubleshooting Guides', slug: 'troubleshooting-guides', category: 'tutorials', order: 4 },
    ],
  },
];
